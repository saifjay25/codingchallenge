...
import com.mycode.codingchallenge.adapters.StatsAdapter
...
class Stats : Fragment() {
    ...
    private var listener: Games.OnFragmentInteractionListener? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recycl = view.findViewById(R.id.recyclerViewStats)
        return view
    }
    ...
    override fun onStart() {
        super.onStart()
            ...
            adapter = StatsAdapter(activity!!.applicationContext, allData)
            recycl.adapter = adapter
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is Games.OnFragmentInteractionListener) {
            listener = context
        } else {
